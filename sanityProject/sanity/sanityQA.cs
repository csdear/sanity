...
namespace sanity
{
    ...
    public class QaSanity
    {
        ...
        public void SetupTest()
        {
            ...
            baseURL = "http://qa.2010.setbuyatoyota.com/";
        ...
        public void QaSanityMain()
        {

            driver.Navigate().GoToUrl("http://qa.2010.setbuyatoyota.com/");
            Thread.Sleep(5000);
            
            // Note :  Toyota Staging Site Credetnails will need to be input manually before starting test.  
            //id:toyota-ext pw:sT@g1ngXS
            ...
            driver.Manage().Timeouts().ImplicitlyWait(TimeSpan.FromSeconds(30));
            driver.Navigate().GoToUrl("http://qa.2010.setbuyatoyota.com/#family=Scion&series=2012+Scion+xB");
            driver.Manage().Timeouts().ImplicitlyWait(TimeSpan.FromSeconds(30));
            Thread.Sleep(10000);
            ...
            //Success!
            driver.FindElement(By.XPath("//img[@alt='2011 Scion xB']")).Click();
